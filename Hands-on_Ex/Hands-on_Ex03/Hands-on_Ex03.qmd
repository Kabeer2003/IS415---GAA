...
childcareSG_ppp.km$lat <- as.numeric(childcareSG_ppp.km$lat)
childcareSG_ppp.km$lon <- as.numeric(childcareSG_ppp.km$lon)
childcareSG_ppp.km$lat <- round(childcareSG_ppp.km$lat, 3)
childcareSG_ppp.km$lon <- round(childcareSG_ppp.km$lon, 3)
```
