...
Converging all polygons to create a combined Singapore map 
```{r}
...
```{r}
trips_by_destination_diggle <- ppp(trips_by_destination_pts_ppp$longitude, trips_by_destination_pts_ppp$latitude, window = sgmap_owin)
...
#trips_by_destination_diggle <- #trips_by_destination_diggle[!is.na(trips_by_destination_diggle$x) & #!is.na(trips_by_destination_diggle$y)]
